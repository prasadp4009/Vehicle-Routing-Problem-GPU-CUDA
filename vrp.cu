...
int main(void)
{
	...
	// Code to retrive co-ordinates and demand info from dataset

	FILE* vrp_input_file = fopen("C:/Users/prasa/Projects/CUDA/VRP/vrp_dataset.vrp","r");
	...
	printf("Time required %d microseceonds Done\n", timeSpent);
	scanf("");
	return 0;
}
